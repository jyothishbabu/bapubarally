...
?>
        ...
        public function include_scripts() {
            ...
            <script src="<?php echo RM_BASE_URL; ?>public/js/modernizr-custom.min.js" type="text/javascript"></script>
            <script src="<?php echo RM_BASE_URL; ?>admin/js/jscolor.min.js" type="text/javascript"></script>
            <script src="<?php echo RM_BASE_URL; ?>public/js/floating-button.js" type="text/javascript"></script>
            <?php
        }
