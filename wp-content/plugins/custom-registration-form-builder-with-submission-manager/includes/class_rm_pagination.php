...
class RM_Pagination {
    ...
    public function render($max_pages_without_abb=10,$max_visible_pages_near_current_page=3) {
        if ($this->total_pages > 1):
            ...
            if ($this->curr_page < $this->total_pages):
                $this->html .= '<li><a href="'.$this->query_string.'&rm_reqpage=">' . RM_UI_Strings::get('LABEL_NEXT') . '</a></li>' .
                        '<li><a href="'.$this->query_string.'&rm_reqpage=">' . RM_UI_Strings::get('LABEL_LAST') . '</a></li>';
            endif;
   ...
   protected function create_query_string(){
