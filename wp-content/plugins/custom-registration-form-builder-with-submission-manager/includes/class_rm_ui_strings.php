    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'USERNAME_EXISTS':
                return __("This user is already registered. Please try with different username.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_HIDE_PREV_BUTTON':
                 return __("Enabling this will remove previous button from multi-page forms, thus prohibiting user from navigating back to already filled pages witout reloading the form.", 'custom-registration-form-builder-with-submission-manager');
