<div class="rmagic">
    ...
    <div class="rm-support-container">
        ...
        <div class="rm-support-block">
            <div class="rm-support-block-title">Want to help us?</div>    
        ...
        <div class="rm-support-block">
            <div class="rm-support-block-title">Want a feature added?</div>    
            <div class="rm-support-block-image">
        ...
        <div class="rm-support-block">
            <div class="rm-support-block-title">General Support</div>    
            <div class="rm-support-block-image">
        ...
        <div class="rm-support-block">
            <div class="rm-support-block-title">Roll Back to v 2.5</div>    
            <div class="rm-support-block-image">
                <img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__))) . 'images/roll_back.jpg'; ?>">
            </div>
            <div class="rm-support-block-text">If you wish to roll back to earlier version of RegistrationMagic due to broken upgrade, download below. You will need to deactivate or uninstall this version and reinstall version 2.5. No data will be lost.</div>
            <div class="rm-support-block-button"><a href="http://registrationmagic.com/free/">Download Now</a></div>
        </div>
