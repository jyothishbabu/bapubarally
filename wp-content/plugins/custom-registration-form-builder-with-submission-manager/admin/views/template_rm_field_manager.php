...
<ul class="rm-field-container rm_sortable_form_fields">
                ...
                ?>
                                    ...
                                    <div class="rmrow">
                                    <div class="rm_buy_pro_inline"><a href="http://registrationmagic.com/?download_id=19544&edd_action=add_to_cart" target="blank"><?php echo RM_UI_Strings::get('MSG_BUY_PRO_GOLD_MULTIPAGE'); ?></a>
                                    </div>
                                    </div>
