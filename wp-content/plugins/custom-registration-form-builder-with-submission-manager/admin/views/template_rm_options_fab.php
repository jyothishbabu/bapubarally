...
<div class="rmagic">
    ...
    <div class="rmcontent">
       ...
       $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_SHOW_SUBMISSION_TAB'), "sub_tab", array(1 =>''),array("id" => "id_rm_fabl1", "class" => "fab_l1" , "value" =>'', "disabled" => "disabled",  "longDesc" => RM_UI_Strings::get('HELP_SHOW_SUBMISSION_TAB'))));
       $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_SHOW_PAYMENT_TAB'), "pay_tab", array(1 => ''),array("id" => "id_rm_fabl1", "class" => "fab_l1" , "value" =>'', "disabled" => "disabled", "longDesc" => RM_UI_Strings::get('HELP_SHOW_PAYMENT_TAB'))));
       $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_SHOW_DETAILS_TAB'), "det_tab", array(1 => ''),array("id" => "id_rm_fabl1", "class" => "fab_l1" , "value" =>'', "disabled" => "disabled", "longDesc" => RM_UI_Strings::get('HELP_SHOW_DETAILS_TAB'))));
         ...
         $form->addElement(new Element_Radio("<b>" . RM_UI_Strings::get('LABEL_FAB_LINK_TYPE') . ":</b>", "fab_link_type1", array('page' => 'Page', 'url' => 'URL'), array("id" => "rm_", "class" => "fab_link_type1", "disabled" => "disabled", "value" => 'page', "longDesc" => '')));
        ...
        $form->addElement(new Element_Select("<b>" . RM_UI_Strings::get('LABEL_PAGE') . ":</b>", "fab_link_page1", $pages, array("id" => "rm_form_type", "value" =>null,"disabled" => "disabled", "longDesc" => '')));
        $form->addElement(new Element_Select("<b>" . RM_UI_Strings::get('LABEL_VISIBILITY') . ":</b>", "fab_link_role_page1", $roles, array("id" => "rm_form_type", "value" =>null,"disabled" => "disabled", "longDesc" => '')));
        $form->addElement(new Element_HTML('</div>'));
        $form->addElement(new Element_HTML("</div>"));
        
        //Second link starts
         $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_SHOW_FAB_LINK2'), "fab_link2", array("yes" => ''),array("id" => "id_rm_fabl2", "class" => "fab_l2" , "value" =>  null, "disabled" => "disabled")));
       
     //Third link starts
        
        
          $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_SHOW_FAB_LINK3'), "fab_link3", array("yes" => ''),array("id" => "id_rm_fabl3", "class" => "fab_l3" , "value" =>  null,  "disabled" => "disabled")));
