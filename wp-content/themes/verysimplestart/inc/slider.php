...
//Slider template
if ( ! function_exists( 'verysimplestart_slider_template' ) ) :
function verysimplestart_slider_template() {
    ...
    if ( !function_exists('pll_register_string') ) {
        $slider_title_1     = get_theme_mod('slider_title_1', 'Start Your Website in Minutes');
        $slider_title_2     = get_theme_mod('slider_title_2', 'Customize Your Site With Ease');
        ...
        $slider_subtitle_1  = get_theme_mod('slider_subtitle_1','Try Very Simple Start!');
        $slider_subtitle_2  = get_theme_mod('slider_subtitle_2', 'Create the site you want with the powerful customization options');
        ...
        $slider_button      = get_theme_mod('slider_button_text', 'Start Now');
        $slider_button_url  = get_theme_mod('slider_button_url','#primary');        
    } else {
        $slider_title_1     = pll__(get_theme_mod('slider_title_1', 'Start Your Website in Minutes'));
        $slider_title_2     = pll__(get_theme_mod('slider_title_2', 'Customize Your Site With Ease'));
        ...
        $slider_subtitle_1  = pll__(get_theme_mod('slider_subtitle_1','Try Very Simple Start!'));
        $slider_subtitle_2  = pll__(get_theme_mod('slider_subtitle_2', 'Create the site you want with the powerful customization options'));
        ...
        $slider_button      = pll__(get_theme_mod('slider_button_text', 'Start Now'));
