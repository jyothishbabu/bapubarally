...
class VerySimpleStart_Skills extends WP_Widget {

    function verysimplestart_skills() {
		$widget_ops = array('classname' => 'verysimplestart_skills_widget', 'description' => __( 'Show your visitors some of your skills.', 'verysimplestart') );
        parent::__construct(false, $name = __('Very Simple Start FP: Skills', 'verysimplestart'), $widget_ops);
		$this->alt_option_name = 'verysimplestart_skills_widget';
	...
	<!-- skill one -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_one'); ?>"><?php _e('First skill name', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_one_max'); ?>"><?php _e('First skill value', 'verysimplestart'); ?></label>
	...
	<!-- skill two -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_two'); ?>"><?php _e('Second skill name', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_two_max'); ?>"><?php _e('Second skill value', 'verysimplestart'); ?></label>
	...
	<!-- skill three -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_three'); ?>"><?php _e('Third skill name', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_three_max'); ?>"><?php _e('Third skill value', 'verysimplestart'); ?></label>
	...
	<!-- skill four -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_four'); ?>"><?php _e('Fourth skill name', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_four_max'); ?>"><?php _e('Fourth skill value', 'verysimplestart'); ?></label>
	...
	function update($new_instance, $old_instance) {
		...
		if ( isset($alloptions['verysimplestart_skills']) )
			delete_option('verysimplestart_skills');		  
		  
		return $instance;
	}
	
	function flush_widget_cache() {
		wp_cache_delete('verysimplestart_skills', 'widget');
	}
	...
	function widget($args, $instance) {
		$cache = array();
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'verysimplestart_skills', 'widget' );
		}
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'verysimplestart_skills', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	}
