...
class VerySimpleStart_Action extends WP_Widget {

    function verysimplestart_action() {
		$widget_ops = array('classname' => 'verysimplestart_action_widget', 'description' => __( 'Display a call to action block.', 'verysimplestart') );
        parent::__construct(false, $name = __('Very Simple Start FP: Call to action', 'verysimplestart'), $widget_ops);
		$this->alt_option_name = 'verysimplestart_action_widget';
	...
	?>
	<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'verysimplestart'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></p>
	<p><label for="<?php echo $this->get_field_id('action_text'); ?>"><?php _e('Enter your call to action.', 'verysimplestart'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_link'); ?>"><?php _e('Link for the button', 'verysimplestart'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_text'); ?>"><?php _e('Title for the button', 'verysimplestart'); ?></label>
	...
	<label for="<?php echo $this->get_field_id( 'inline' ); ?>"><?php _e( 'Display the button inline with the text?', 'verysimplestart' ); ?></label></p>
	<?php
	}
	...
	function update($new_instance, $old_instance) {
		...
		if ( isset($alloptions['verysimplestart_action']) )
			delete_option('verysimplestart_action');		  
		  
		return $instance;
	}
	
	function flush_widget_cache() {
		wp_cache_delete('verysimplestart_action', 'widget');
	}
	
	function widget($args, $instance) {
		$cache = array();
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'verysimplestart_action', 'widget' );
		}
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'verysimplestart_action', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	}
