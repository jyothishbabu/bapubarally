...
class VerySimpleStart_List extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'widget_list', 'description' => __('A simple list widget', 'verysimplestart'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('list', __('Very Simple Start FP: List','verysimplestart'), $widget_ops, $control_ops);
	}
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('text'); ?>"><?php _e('Add a bit of text here. It will be displayed.', 'verysimplestart'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('list'); ?>"><?php _e('Add your list items here. One item per row, start each row with <strong>^</strong>. Example: <strong>^ list item </strong>', 'verysimplestart'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('button_url'); ?>"><?php _e('Call to action button URL:', 'verysimplestart'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('button_text'); ?>"><?php _e('Call to action button text:', 'verysimplestart'); ?></label>
