...
class VerySimpleStart_Facts extends WP_Widget {

// constructor
    function verysimplestart_facts() {
		$widget_ops = array('classname' => 'verysimplestart_facts_widget', 'description' => __( 'Show your visitors some facts about your company.', 'verysimplestart') );
        parent::__construct(false, $name = __('Very Simple Start FP: Facts', 'verysimplestart'), $widget_ops);
		$this->alt_option_name = 'verysimplestart_facts_widget';
	...
	?>
	<p><?php _e('You can find a list of the available icons ', 'verysimplestart'); ?><a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_blank"><?php _e('here.', 'verysimplestart'); ?></a>&nbsp;<?php _e('Usage example: <strong>fa-android</strong>', 'verysimplestart'); ?></p>
	<p>
	<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'verysimplestart'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
	</p>

	<!-- fact one -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_one'); ?>"><?php _e('First fact name', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_one_max'); ?>"><?php _e('First fact value', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_one_icon'); ?>"><?php _e('First fact icon', 'verysimplestart'); ?></label>
	...
	<!-- fact two -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_two'); ?>"><?php _e('Second fact name', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_two_max'); ?>"><?php _e('Second fact value', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_two_icon'); ?>"><?php _e('Second fact icon', 'verysimplestart'); ?></label>
	...
	<!-- fact three -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_three'); ?>"><?php _e('Third fact name', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_three_max'); ?>"><?php _e('Third fact value', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_three_icon'); ?>"><?php _e('Third fact icon', 'verysimplestart'); ?></label>
	...
	<!-- fact four -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_four'); ?>"><?php _e('Fourth fact name', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_four_max'); ?>"><?php _e('Fourth fact value', 'verysimplestart'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_four_icon'); ?>"><?php _e('Fourth fact icon', 'verysimplestart'); ?></label>
	...
	function update($new_instance, $old_instance) {
		...
		if ( isset($alloptions['verysimplestart_facts']) )
			delete_option('verysimplestart_facts');		  
		  
		return $instance;
	}
	
	function flush_widget_cache() {
		wp_cache_delete('verysimplestart_facts', 'widget');
	}
	...
	function widget($args, $instance) {
		$cache = array();
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'verysimplestart_facts', 'widget' );
		}
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'verysimplestart_facts', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	}
